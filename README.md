...
- **Bank Selection**: Choose one or multiple data sources from the most popular banks in Ukraine (NBU, PrivatBank, Monobank).
- **Precision Configuration**: Adjust the number of decimal places displayed for exchange rates.
- **Scheduled Notifications**: Receive daily updates at a specified time.
...
- **TelegramBots Java Library** – a third-party library for working with the Telegram Bot API
...
The bot provides a clear and intuitive interface with buttons for managing preferences and receiving exchange rates.
...
The response includes buy/sell rates for selected currencies and banks, based on your settings:
...
#### Enable or disable daily notifications and set the time
